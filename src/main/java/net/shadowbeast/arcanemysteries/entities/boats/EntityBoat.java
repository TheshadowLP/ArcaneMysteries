...
public class EntityBoat extends Boat {
    ...
    public EntityBoat.Type getModVariant() {
        return EntityBoat.Type.byId(this.entityData.get(DATA_ID_TYPE));
    }
    ...
    protected void readAdditionalSaveData(CompoundTag pCompound) {
        if (pCompound.contains("Type", 8)) {
            this.setVariant(EntityBoat.Type.byName(pCompound.getString("Type")));
        }
    }
    public enum Type implements StringRepresentable {
        ...
        public static final StringRepresentable.EnumCodec<EntityBoat.Type> CODEC = StringRepresentable.fromEnum(EntityBoat.Type::values);
        ...
        public static EntityBoat.Type byId(int pId) { return BY_ID.apply(pId); }
        public static EntityBoat.Type byName(String pName) { return CODEC.byName(pName, FROZEN); }
    }
}
